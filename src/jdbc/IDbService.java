...
/*
* Напишите утилитарный (вспомогательный) класс DbServer, который наследует
* интерфейс IDbService.
* Реализация классов Documents, Author и DocumentException приведены вприложении.
* Продемонстрируйте работу класса DbServer с базой данных test (см.задачу №1).
 */
public interface IDbService extends AutoCloseable {
     ...
     * общей ошибки доступа к базе данных
     */
    boolean addDocument(Documents doc, Authors author) throws
            DocumentException;
     ...
     * базе данных
     */
    Documents[] findDocumentByAuthor(Authors author) throws
            DocumentException;
     ...
     */
    Documents[] findDocumentByContent(String content) throws
            DocumentException;
     ...
     * общей ошибки доступа к базе данных.
     */
    boolean deleteAuthor(Authors author) throws
            DocumentException;
